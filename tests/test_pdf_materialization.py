...
class TestPdfMaterialization(TestCase):
    ...
    def _assert_json_strings(self, series, expected):
        ...
        self.assertTrue(all(isinstance(x, str) for x in series))
    ...
    def test_baseline_homogeneous(self):
        ...
        self.assertEqual(list(pdf["a"]), [Decimal("1"), Decimal("2"), Decimal("3")])
        ...
        self.assertEqual(
            [list(a) for a in pdf["arr"]],
            [[Decimal("1"), Decimal("2"), Decimal("3")]] * 3,
        )
    ...
    def test_nulls_treated_as_absent(self):
        ...
        self.assertEqual(list(pdf["a"]), [Decimal("1"), Decimal("2")])
    ...
    def test_numeric_mixing(self):
        ...
        self.assertEqual(list(pdf["n"]), [Decimal("1"), Decimal("1.5")])
        ...
        self.assertEqual(list(pdf["n"]), [Decimal("9223372036854775807"), Decimal("1")])
        ...
        self.assertEqual(
            list(pdf["n"]), [Decimal("92233720368547758070"), Decimal("1")]
        )
    ...
    def test_shape_boundaries(self):
        ...
        self.assertEqual(
            [list(pdf["a"]), list(pdf["b"])], [[Decimal("1")], [Decimal("2")]]
        )
        ...
        self.assertEqual(
            list(pdf["__value"]), [Decimal("1"), Decimal("2"), Decimal("3")]
        )
    ...
    def test_temporal_types(self):
        ...
        self.assertEqual(list(pdf["t"]), ["2020-01-01T10:00:00", "2021-01-01T00:00:00"])
